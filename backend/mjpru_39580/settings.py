"""
Django settings for mjpru_39580 project.
...
WSGI_APPLICATION = 'mjpru_39580.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mjpru_39580 API",
    "DESCRIPTION": "API documentation for mjpru_39580 App",
    "VERSION": "v1",
}
